...
export const fetchRealtimeDailyData = sym => (
  $.ajax({
    ...
    url: `https://api.intrinio.com/historical_data?identifier=${sym}&start_date=2014-02-27&item=adj_close_price&page_size=2000&sort_order=asc&api_key=${window.API_OPTIONS.intrinioApiKey}`,
    type: "OPTIONS",
    dataType: "JSON",
  })
);
